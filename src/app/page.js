    ...
    return (
        <>
            ...
            <div className="flex flex-wrap items-center justify-around border-y-2 border-solid border-gray-400 my-3 p-3">
                ...
                <img
                    className="w-14"
                    src="adidas-svgrepo-com.svg"
                    alt="adidas"
                />
                <img
                    className="w-14"
                    src="brand-nike-svgrepo-com.svg"
                    alt="nike"
                />
            </div>
            ...
            >
                <p className="text-white font-bold">
                    Founded in the enchanting town of Soleburg in 1898 by
                    cobbler Bartholomew Footworthy, FootElegance quickly became
                    synonymous with unrivaled craftsmanship. Blending secret
                    family leather treatments and an unwavering passion, the
                    brand soared to global fame. From the roaring twenties'
                    "DanceFlex" to the disco-era "MirrorStride," FootElegance's
                    innovative designs have left an indelible mark on fashion
                    history. Today, the Footworthy family legacy lives on, with
                    each pair of FootElegance shoes a testament to a
                    century-long commitment to comfort, style, and a touch of
                    whimsy.
                </p>
            </div>
