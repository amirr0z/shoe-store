    ...
    return (
        <div className="p-2 text-center flex items-center flex-col">
            ...
            <p className="first-letter:font-extrabold first-letter:text-xl">
                ...
                visionary shoe company redefining the boundaries of footwear.
                Our passion lies in the fusion of cutting-edge technology and
                timeless design, ensuring every step is a statement. From our
                sustainable materials to ergonomic engineering, VelociSoles is
                not just a brand; it's a commitment to comfort, fashion, and a
                sustainable future. Walk confidently, stand uniquely —
                experience the extraordinary with VelociSoles.
            </p>
            <p className="first-letter:font-extrabold first-letter:text-xl">
